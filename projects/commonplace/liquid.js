/* ---------------------------------------------------------------------------
 * Canvas UI — "Liquid" (vanilla)
 * Source: https://canvasui.dev/r/liquid-vanilla.json  (shadcn registry)
 * Author: David Haz (DavidHDev) — https://github.com/DavidHDev/canvas-ui
 * License: MIT + Commons Clause. Free in personal/commercial work; may not be
 *          resold or redistributed as a component library.
 *
 * Unmodified apart from being transpiled from TypeScript to plain ES module JS.
 * Effect parameters and DOM arrangement live in commonplace.js, not here.
 * ------------------------------------------------------------------------- */
const DEFAULTS = {
  simResolution: 128,
  dyeResolution: 512,
